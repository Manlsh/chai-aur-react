  ...
  return (
    <div className="mx-auto w-full max-w-7xl">
            ...
            text-black rounded-lg sm:mx-16 mx-2 sm:py-16">
                ...
                px-4  pb-20 pt-10 sm:py-24 
                mx-auto sm:px-6 lg:px-8">
                    <div className="max-w-xl sm:mt-1 
                    mt-80 space-y-8 text-center 
                    sm:text-right sm:ml-auto">
                        ...
                        >
                            ...
                            >
                                ...
                                <path d="M1.571 23.664l10.531-10.501 
                                3.712 3.701-12.519 6.941c-.476.264-1.059.26-1.532-.011l-.192-.13zm9.469-11.56l-10.04 10.011v-20.022l10.04 
